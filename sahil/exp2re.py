        ...
        for alpha,beta in itertools.product(range(4), range(10)):
                ...
                for j in range(numIter):
                                ...
                                if i%25 == 0:
                                                ...
                                                writeWav(reconstructed.astype(np.float32), filename = "wavdumpsRe/temp_re"+str(j)+".wav")
                                                writeWav(ugdata[j*bs:j*bs+1,:,:,:], filename = "wavdumpsRe/original_re" + str(j) + ".wav")
